  ...
  constructor(a, b, c, d, f) {
    ...
    if (b.highlightScanRegion || b.highlightCodeOutline) {
      ...
      if (!d && b.highlightScanRegion) {
        this.$overlay.innerHTML = `<svg class="scan-region-highlight-svg" fill="none" stroke="white" stroke-linecap="round" stroke-linejoin="round" stroke-width="10" style="height:100%;left:0;position:absolute;top:0;width:100%" preserveAspectRatio="none" version="1.1" viewBox="0 0 238 238" xmlns="http://www.w3.org/2000/svg">
          <g stroke="none">
