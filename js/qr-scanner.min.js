...
class e {
    ...
    if (b.highlightScanRegion || b.highlightCodeOutline) {
      ...
      if (!d && b.highlightScanRegion) {
        this.$overlay.innerHTML =
          '<svg class="scan-region-highlight-svg" viewBox="0 0 238 238" preserveAspectRatio="none" style="position:absolute;width:100%;height:100%;left:0;top:0;fill:none;stroke:#FFFFFF;stroke-width:10;stroke-linecap:round;stroke-linejoin:round"><path d="M31 2H10a8 8 0 0 0-8 8v21M207 2h21a8 8 0 0 1 8 8v21m0 176v21a8 8 0 0 1-8 8h-21m-176 0H10a8 8 0 0 1-8-8v-21"/></svg>';
        try {
  ...
  async _getCameraStream() {
    ...
    let a = /^(environment)$/.test(this._preferredCamera)
        ? "facingMode"
        : "deviceId",
      // Set the minimum camera size
      b = [{}, {}],
      c = b.map((d) =>
